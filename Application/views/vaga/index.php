<?php
$message = "";
if (isset($_POST['inputText'])) { //check if form was submitted
                    ...
                    <div class="col-8">
                        <div class="bg-light rounded-3 ">
                            <div class="container-fluid py-5 bg-secondary bg-opacity-10">
                                <h2 class="fw-bold">Estágiario</h2>
                                <a href="#" class="link-secondary">
                                    <p class="fw-normal fs-5">Amazon</p>
                                </a>
                                ...
                                <div class="list-group list-group-flush border-bottom scrollarea">
                                    <form action="" method="post">
                                        <?php foreach ($data['vagas'] as $vaga) { ?>
                                            <button type="submit" name="inputText" value="<?= $vaga['id']?>">
