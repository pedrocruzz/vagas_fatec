...
<body>
    ...
    <div class="container" style="padding-left: 200px;">
        <div class="card" <?php if (empty($data['vagas'])) {
            ...
            <h2 class="card-header text-center bg-light link-secondary">Vagas Fechadas</h2>
            <div class="container p-3">
                <div class="card-body">
                    <?php if (empty($data['vagas'])) {
                        echo '<p class=" text-center text-muted">Não há nehuma vaga fechada no momento.</p>';
                    } ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <form method="POST" action="#">
                                        ...
                                        <button class="btn btn-secondary" name="Vercandidatos" type="submit">Candidatos</button>
                                    </form>
                                </div>
                            </div>
                        </div>
