...
if (isset($_POST['definirParceria'])) {
    ...
    $result = Empresas::concederParceria($data);
    header('location:/administrador/concederParceria');
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container p-3">
                <div class="card-body">
                    <?php if (empty($data['empresas'])) {
                        echo '<p class=" text-center text-muted">Não há nenhuma empresa para se conceder parceria.</p>';
                    } ?>
                    <?php if (empty($data['empresas'])) {
                        echo '<div class="alert bg-light text-muted text-center" role="alert">
                        Conceda um selo às empresas afiliadas para que todos saibam sobre a sua parceria!
                    </div>';
                    } ?>
                        ...
                        <div class="card" style="margin-bottom: 3%;">
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <form method="POST">
                                        <input type="hidden" name="parceria" value="1">
                                        <input type="hidden" name="id" value="<?= $empresa['id'] ?>">
                                        <button class="btn btn-danger" name="definirParceria" type="submit">Conceder selo de parceria</button>
                                    </form>
                                </div>
                            </div>
                        </div>
